...
namespace Voxelgine.States
{
	public unsafe partial class MPClientGameState
	{
		...
		private void UpdateNetStats()
		{
			...
			_netStatsInfoLabel.WriteLine($"Queues: {WorldDecodeQueueDepth} decode / {WorldApplyQueueDepth} apply / {WorldDeferredAcknowledgements} deferred ACK");
			_netStatsInfoLabel.WriteLine($"Streaming paused: {WorldStreamingBackpressured}");
